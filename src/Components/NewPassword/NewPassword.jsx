...
export default function NewPassword() {
    ...
    return (
        <form
            ...
            className="w-[80%] lg:w-[50%] mx-auto bg-white p-6 sm:p-8 rounded-xl shadow-xl border border-gray-200 my-20"
        >
            <h2 className="text-green-600 text-2xl my-3">Reset Your Password</h2>
            ...
            <div className="relative z-0 w-full mb-6 group">
                <input
                    type="email"
                    value={newPasswordFormik.values.email}
