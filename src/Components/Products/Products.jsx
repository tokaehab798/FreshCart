    ...
    return <>
        <section>
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-4 relative max-w-[70%] sm:max-w-[180px] md:max-w-full mx-auto">
